...
knitr::include_graphics("./assets/images/2-Stat/sas_1.PNG")
```

```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("./assets/images/2-Stat/sas_2.png")
```
]
...
.center-img[
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("./assets/images/2-Stat/sas_3.png")
```
]
...
.pull-right[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/R_1.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/R_2.png")
```
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("./assets/images/2-Stat/python.png")
```
...
- Orange pour l'analyse de donénes
